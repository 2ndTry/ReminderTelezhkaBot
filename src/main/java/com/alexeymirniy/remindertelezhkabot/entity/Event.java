...
public class Event {
    ...
    @Size(min = 0, max = 200, message = "Description must be between 0 and 200 chars!")
    ...
    public Event(
            ...
            @Size(min = 0, max = 200, message = "Description must be between 0 and 200 chars!") String description,
            EventFreq freq,
            User user) {

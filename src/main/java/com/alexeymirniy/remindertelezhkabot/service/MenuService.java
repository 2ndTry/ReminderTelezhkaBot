...
public class MenuService {
    ...
    public InlineKeyboardMarkup getInlineMessageButtonsForEnterDate() {
        ...
        InlineKeyboardButton buttonOneEveryDay = new InlineKeyboardButton();
        buttonOneEveryDay.setText("Ежедневно");
        ...
        buttonOneEveryDay.setCallbackData("buttonOneEveryDay");
        ...
        keyboardButtonsRow1.add(buttonOneEveryDay);
    ...
    public ReplyKeyboard getInlineMessageButtonsAllUser() {
        ...
        buttonDelUser.setText("Delete user");
